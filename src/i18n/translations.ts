...
export const translations = {
  fr: {
    ...
    nav: {
      ...
      protocol: 'Plateforme / App',
      practitioners: 'Team augmentée + élargie',
      contact: 'Parlons-en',
    },
    ...
    hero: {
      ...
      sub2: 'Énergie + Collective pour des comportements plus rapides, plus rassurants, plus responsables, plus réalistes',
      cta1: 'Découvrir la Méthode',
      cta2: 'Parlons-en',
      ec2rLines: {
        e: 'Énergie',
        c1: 'Collective',
        c2cycling: ['Croissance', 'Changements', 'Comportements'],
    ...
    methode: {
      ...
      energies: [
        ...
        { name: 'Animer', qualifier: 'coopération collective', description: "La force du collectif naît de la coopération réelle : pas d'un discours. Tensions adressées, complémentarités activées." },
  ...
  en: {
    ...
    methode: {
      ...
      energies: [
        ...
        { name: 'Center', qualifier: 'towards success', description: "All in unison to cooperate effectively. Clear expectations, global coherence, results-oriented cooperative dynamic." },
        ...
        { name: 'Animate', qualifier: 'collective cooperation', description: "Collective strength comes from real cooperation : not speeches. Tensions addressed, complementarities activated." },
